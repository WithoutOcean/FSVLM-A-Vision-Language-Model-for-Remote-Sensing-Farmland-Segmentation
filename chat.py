...
def parse_args(args):
    ...
    parser.add_argument("--version", default="your model weight")
    parser.add_argument("--vis_save_path", default="./vis_output", type=str)
    parser.add_argument("--base_dir", default="test data path", type=str)
...
def main(args):
    ...
    model.get_model().initialize_vision_modules(model.get_model().config,encode_type=args.encode_type,RSCLIP_weight_path=args.RSCLIP_weight_path,GeoRS_path=args.GeoRS_path)
    ...
    masks_paths=glob.glob(os.path.join(args.base_dir,"fusai","lbl","*.png"))
